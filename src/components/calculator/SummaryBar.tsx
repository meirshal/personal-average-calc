...
export default function SummaryBar({ summary }: SummaryBarProps) {
  return (
    <div className="sticky top-0 z-[100] bg-white border-b border-slate-200 py-3 px-4 flex gap-3 justify-center items-center shadow-[0_1px_3px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.06)]">
